			...
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">${search.mname}</h3>
					</div>
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="thumbnail">
								...
								<div class="caption">
									<h5>DIRECTED BY:${search.mdirector}</h5>
									<h5>RELEASED ON:${search.releasedate}</h5>
									<h5>CAST:${search.starring}</h5>
									<h5>GENRE:${search.genre}</h5>
									<h5>RUN TIME:${search.runtime}</h5>
									<P>${search.plot}</P>
